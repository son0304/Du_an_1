...
<div class="container mt-5">
    <h2 class="mb-4 text-center text-primary">🛒 Giỏ hàng của <?= $_SESSION['user']['name'] ?></h2>
        ...
        <div class="row align-items-start py-3 cart-row cart-item" data-id="<?= $cart['id'] ?>" data-total="<?= $itemTotal ?>">
            <div class="col-md-6">
                <div class="product-info">
                    <img src="/Du_an_1/Assets/image/products/<?= $cart['product_image'] ?>" alt="Sản phẩm">
                    <div>
                        <div class="product-name"><?= $cart['product_name'] ?></div>
                        <div class="product-size">Size: <?= $cart['size_name'] ?></div>
                    </div>
                </div>
