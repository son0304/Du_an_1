...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['action_type'] === 'login') {
        $errorsLogin = $auth->login();
    } elseif ($_POST['action_type'] === 'register') {
        $errorsRegister = $auth->register();
    }
}
?>
        ...
        <form action="" method="POST" novalidate>
            ...
            <div class="mb-3">
                <input type="text" class="form-control" name="name" placeholder="Tên đăng nhập"
                       value="<?= ($_POST['action_type'] ?? '') === 'login' ? htmlspecialchars($_POST['name'] ?? '') : '' ?>" required />
                <?php if (isset($errorsLogin['name'])): ?>
                    <span class="text-danger"><?= $errorsLogin['name'] ?></span>
                <?php endif; ?>
            </div>
            <div class="mb-3">
                <input type="password" class="form-control" name="password" placeholder="Mật khẩu" required />
                <?php if (isset($errorsLogin['password'])): ?>
                    <span class="text-danger"><?= $errorsLogin['password'] ?></span>
                <?php endif; ?>
            </div>
        ...
        <form action="" method="POST" class="needs-validation" novalidate>
            ...
            <div class="mb-2">
                <input type="text" name="name" class="form-control" placeholder="Tên đăng nhập"
                       value="<?= ($_POST['action_type'] ?? '') === 'register' ? htmlspecialchars($_POST['name'] ?? '') : '' ?>" required />
                <?php if (isset($errorsRegister['name'])): ?>
                    <span class="text-danger"><?= $errorsRegister['name'] ?></span>
                <?php endif; ?>
            </div>
            <div class="mb-2">
                <input type="email" name="email" class="form-control" placeholder="Email"
                       value="<?= ($_POST['action_type'] ?? '') === 'register' ? htmlspecialchars($_POST['email'] ?? '') : '' ?>" required />
                <?php if (isset($errorsRegister['email'])): ?>
                    <span class="text-danger"><?= $errorsRegister['email'] ?></span>
                <?php endif; ?>
            </div>
            <div class="mb-2">
                <input type="password" name="password" class="form-control" placeholder="Mật khẩu" required />
                <?php if (isset($errorsRegister['password'])): ?>
                    <span class="text-danger"><?= $errorsRegister['password'] ?></span>
                <?php endif; ?>
            </div>
            <div class="mb-2">
                <input type="tel" name="phone" class="form-control" placeholder="Số điện thoại"
                       value="<?= ($_POST['action_type'] ?? '') === 'register' ? htmlspecialchars($_POST['phone'] ?? '') : '' ?>" required />
                <?php if (isset($errorsRegister['phone'])): ?>
                    <span class="text-danger"><?= $errorsRegister['phone'] ?></span>
                <?php endif; ?>
            </div>
            <div class="mb-3">
                ...
                <textarea id="address" name="address" class="form-control" rows="2" placeholder="Địa chỉ" required><?= ($_POST['action_type'] ?? '') === 'register' ? htmlspecialchars($_POST['address'] ?? '') : '' ?></textarea>
                ...
                <?php if (isset($errorsRegister['address'])): ?>
                    <span class="text-danger"><?= $errorsRegister['address'] ?></span>
                <?php endif; ?>
            </div>
